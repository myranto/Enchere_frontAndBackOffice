                            ...
                            <div className="container">
                                <div className="containt_main">
                                    <div id="mySidenav" className="sidenav">
                                        ...
                                        <a href="/Historique">historiques encheres</a>
                                        <a href="/ListeEnchere">liste enchere</a>
                                        <a href="/RechercheAvance">recherche avancer</a>
                                    ...
                                    <div className="dropdown">
                                        ...
                                        <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a className="dropdown-item" href="/Historique">historiques encheres</a>
                                            <a className="dropdown-item" href="/ListeEnchere">liste enchere</a>
                                            <a className="dropdown-item" href="/RechercheAvance">recherche avancer</a>
                                        </div>
                                    </div>
                                    <div className="main">
                                        <div className="input-group">
                                            <input type="text" onChange={(event) => setKey(event.target.value)} className="form-control" placeholder="Search auction here" />
